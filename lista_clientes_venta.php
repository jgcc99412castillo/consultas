...
<head>
    <meta charset="UTF-8"> 
     <title>Lista Ventas a Clientes</title>
  ...
  <div class="transp">
    <div class="container">
      <div class="container">
    	...
    	<br>
       <div>
           <center><h1>Listado de Ventas a Clientes</h1></center><br>

          <?php // visualizar Lista de clientes ventas
                   require_once 'conex/conexion.php';
             ...
             <table class="table-responsive">
                ...
                <table id="datatable-buttons" class="table table-hover  table-bordered ">
                  <thead>
                    <tr>
                      ...
                      <th class="active">Estado compra</th>
                      <th class="active"></th>
                    </tr>
                  </thead>
                   ...
                   <tbody>
                             ...
                             $sql = "SELECT id_venta, venta, cedula, nombre FROM venta INNER JOIN cliente  
                  ON venta.id_cliente=cliente.id_cliente WHERE 1 ";
                     ...
                     <tr>
                      ...
                      <td class="danger"><?php echo $row['venta']?></td>

                      <td class="active"><a class="btn btn-danger active" href="valid/eliminar_venta.php?id_venta=<?php echo $row['id_venta']; ?>">
                  <small class="label pull-right bg-red" style="paddin: 10px">Eliminar Venta</small></a></td>
               ...
               <?php     } else{
                         echo "<center><h1>No hay Ventas Realizadas.</h1></center><br /><br />";
                ...
                <div class="col-md-4 col-xs-4">
                 <div id="carousel-1" class="carousel slide" data-ride="carousel" style="max-width: 130%; max-height: ;">
                      <ol class="carousel-indicators">
                          ...
                          <li data-target="#carousel-1" data-slide-to="3" active></li>
