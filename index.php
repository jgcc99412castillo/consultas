  ...
  <div class="transp">
    <div class="container">
      <div class="container">
       ...
       <center><h1>Verificacion de Compra</h1></center>
       <br>

       <form action="valid/verif_cli.php" method="POST" class="">
      ...
      <div class="form-group">
      	  <div class="row">
      	    <div class="col-md-12 col-xs-12 ">
               	<button class="btn btn-primary btn-block active" name="verificar">Verificar</button>
      	    </div>
              ...
              <div class="row">
                 ...
                 <div id="carousel-1" class="carousel slide" data-ride="carousel" style="max-width: 130%; max-height: ;">
                      <ol class="carousel-indicators">
                          ...
                          <li data-target="#carousel-1" data-slide-to="1" active></li>
